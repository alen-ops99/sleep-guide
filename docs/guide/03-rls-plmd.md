...
!!! crvena-zastavica "Crvene zastavice"
    ...
    **Augmentacija** je paradoksalno pogoršanje RLS simptoma uzrokovano dugotrajnom primjenom dopaminskih agonista (**30–50% pacijenata** na pramipeksolu ili ropinirolu; rizik **7–10% godišnje** — JAMA 2026). Prepoznajte je po:
    ...
    - Pacijent traži **povećanje doze**

    > ⚠️ **Ako posumnjate na augmentaciju — NE povećavajte dozu!** Uputite specijalistu za planiranu detoksifikaciju i prijelaz na drugu terapiju.

    ### Sekundarni uzroci RLS-a — obavezno isključiti

    - **Deficit željeza** — najčešći uzrok; feritin „normalan" (>12 ng/mL) ne znači dovoljno za RLS — cilj je **≥100 ng/mL** (AASM 2024)
    - **Kronična bubrežna bolest** — 20–30% pacijenata na dijalizi
    - **Trudnoća** — do 25% trudnica (3. tromjesečje); povlači se nakon poroda
    - **Periferna neuropatija / dijabetes** — mogu koegzistirati s RLS-om
    - **Hipotireoza** — provjerite TSH
    - **Lijekovi koji pogoršavaju RLS** (vidi dolje)

    ### Lijekovi koji pogoršavaju ili provociraju RLS
    ...
    > **Klinički savjet:** Pregledajte postojeću terapiju. Ukidanje antihistaminika ili zamjena antidepresiva na **bupropion** (ne pogoršava RLS) može biti dovoljna intervencija.
...
!!! zamka "Česte zamke"
    ...
    |---|---|
    | *„To je anksioznost"* | Sustavno pitajte 4 IRLS kriterija. Ako su sva 4 prisutna — dijagnoza je RLS. |
    | DA kao prva linija | Prvo feritin (cilj ≥100), pa **alfa-2-delta ligand**. AASM 2024 uvjetno PROTIV rutinske primjene DA. |
    | Antihistaminik za „nemir u nogama" | Antihistaminici **pogoršavaju RLS**! Nikada za nemir u nogama navečer. |
    | Ne prepoznati augmentaciju | „Simptomi ranije? Šire se na ruke?" Ako da — NE povećavajte dozu DA, uputite specijalistu. |
    | Feritin „normalan" (30 ng/mL) | Za RLS cilj je **≥100 ng/mL**. Feritin <75 → oralno/IV; 75–100 → samo IV. |
    | SSRI/SNRI kod RLS pacijenta | Pogoršavaju RLS. Alternativa: **bupropion** ili **trazodon**. |
    | RLS „nije ozbiljan" | Dovodi do kronične nesanice, depresije i KV rizika. Liječi se. |
...
1. Winkelman JW, Armstrong MJ, Allen RP, et al. Practice guideline summary: Treatment of restless legs syndrome in adults. *Neurology*. 2016;87(24):2585-2593. doi:10.1212/WNL.0000000000003388
...
6. Trenkwalder C, Allen R, Högl B, et al. Comorbidities, treatment, and pathophysiology in restless legs syndrome. *Lancet Neurol*. 2018;17(11):994-1005. doi:10.1016/S1474-4422(18)30311-9
...
<!--
NAPOMENE ZA AUTORA:
- Dostupnost lijekova provjerena prema HALMED-u (gabapentin enakarbil i rotigotinski flaster NISU dostupni u RH)
- Feritin cilj ≥100 ng/mL s dvostupanjskim pristupom konzistentan s AASM 2024 (Winkelman 2024)
- DA doziranje uklonjeno iz poglavlja — prepušteno specijalistu (konzistentno s AASM 2024 uvjetnom preporukom PROTIV)
-->
