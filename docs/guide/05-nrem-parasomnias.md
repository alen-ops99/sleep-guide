...
!!! crvena-zastavica "🚩 Crvene zastavice"
    ...
    - **Novonastalo mjesečarenje u odraslog pacijenta** — ovo NIJE normalna varijanta. Obavezno isključiti:
      - **OSA** (fragmentacija sna provocira NREM parasomnije) — pitajte o hrkanju, apnejama, dnevnoj pospanosti
      - **Noćnu epilepsiju** (frontalni režanj) — stereotipne, kratke, ponavljajuće epizode
      - **Lijekove** — zolpidem (čest uzrok!), litij, antihistaminici, neuroleptici
      - **Neurološku bolest** — posebno ako postoji kognitivni pad

    - **Ozljede tijekom epizoda** — padovi niz stepenice, rezanje, udaranje u predmete, napuštanje kuće i izlazak na ulicu. Zahtijeva hitnu procjenu i mjere zaštite.

    - **Nasilno ili agresivno ponašanje** — može dovesti do ozljeda osobe ili partnera. Diferencijalno-dijagnostički razmotriti RBD (posebno u starijih muškaraca).

    - **Stereotipne, kratke epizode (30–60 sekundi), uvijek istog oblika** — visoka sumnja na **noćnu epilepsiju frontalnoga režnja** (NFLE, sada *sleep-related hypermotor epilepsy* — SHE). Ove epizode su kratke, uniformne, mogu se javljati u klasterima i višestruko tijekom jedne noći.

    - **Više epizoda u jednoj noći** — NREM parasomnije se obično javljaju jednom po noći (jer se N3 „potroši"); višestruke epizode upućuju na epilepsiju.

    - **Novonastale parasomnije u starijeg pacijenta (>50 godina)** — razmotriti RBD (prodrom neurodegenerativne bolesti) ili noćnu epilepsiju.
...
!!! zamka "⚠️ Česte zamke"
    ...
    |---|---|
    | Zamijeniti NREM parasomnije s RBD-om | NREM = **prva trećina noći, oči otvorene, amnezija, djeca**; RBD = **zadnja trećina, oči zatvorene, sjećanje na san, stariji muškarci** |
    | Ne tražiti OSA kod odraslih s novonastalim mjesečarenjem | OSA fragmentira san i destabilizira prijelaze između stadija — liječenje OSA može potpuno eliminirati parasomnije |
    | Pokušati probuditi osobu tijekom epizode | Samo osigurati sigurnost i nježno usmjeriti natrag u krevet. Prisilno buđenje može provocirati agitaciju i agresiju |
    | Ne provjeriti lijekove | **Zolpidem** je jedan od najčešćih uzroka NREM parasomnija u odraslih. Uvijek pregledati kompletnu medikamentnu terapiju |
    | Zamijeniti noćne strahove s noćnim morama | Noćni strahovi: **prva trećina noći, nekonzolabilan, amnezija, autonomna aktivacija**. Noćne more: zadnja trećina, dijete se budi, sjeća se sna, traži utjehu |
    | Proglasiti noćnu epilepsiju „parasomniom" | Stereotipne, kratke (<60 s), višestruke epizode u jednoj noći — uputiti neurologu za video-EEG |
    | Propisati lijekove bez otklanjanja triggera | Najprije identificirati i otkloniti provocirajuće čimbenike (deprivacija sna, alkohol, lijekovi, OSA). Farmakoterapija tek ako nefarmakološke mjere ne pomognu |
    | Uznemiriti roditelje djeteta s tipičnim noćnim strahovima | Razuvjeriti: benigno stanje, dijete će prerasti, ne ukazuje na psihijatrijsku bolest |
...
2. Stallman HM, Kohler M. Prevalence of sleepwalking: a systematic review and meta-analysis. *PLoS One.* 2016;11(11):e0164769.
3. Stallman HM. Assessment and treatment of sleepwalking in clinical practice. *Aust Fam Physician.* 2017;46(8):590–593.
4. Stallman HM. Prevalence and treatment of sleepwalking and related disorders. *Sleep Med.* 2018;(tematski pregledni članak — parasomnija).
5. Galbiati A, Rinaldi F, Giora E, Ferini-Strambi L, Marelli S. Behavioural and cognitive-behavioural treatments for parasomnias: a systematic review. *Sleep Med Rev.* 2015;25:75–83.
6. Castelnovo A, Lopez R, Proserpio P, Nobili L, Dauvilliers Y. NREM sleep parasomnias as disorders of sleep-state dissociation. *Nat Rev Neurol.* 2018;14(8):470–481.
7. Provini F, Tinuper P, Bisulli F, Lugaresi E. Arousal disorders. *Sleep Med.* 2011;12(Suppl 2):S22–S26.
8. Tinuper P, Bisulli F, Cross JH, et al. Definition and diagnostic criteria of sleep-related hypermotor epilepsy. *Neurology.* 2016;86(19):1834–1842.
9. Proserpio P, Terzaghi M, Manni R, Nobili L. Drugs used in parasomnia. *Sleep Med Clin.* 2018;13(2):191–202.
10. Zadra A, Desautels A, Petit D, Montplaisir J. Somnambulism: clinical aspects and pathophysiological hypotheses. *Lancet Neurol.* 2013;12(3):285–294.

---

<!--
NAPOMENE ZA AUTORA:
- MKB-10 kodovi provjereni: F51.3 (somnambulizam), F51.4 (noćni strahovi), G47.51 (konfuzna buđenja)
- Klonazepam je dostupan u Hrvatskoj (HALMED, veljača 2026) — Rivotril 0,5 mg i 2 mg tablete
- Zolpidem kao trigger parasomnija — dobro dokumentirano u literaturi (referenca 9, Proserpio 2018)
- Prevalencija somnambulizma: 1-4% odrasli prema Stallman & Kohler 2016 (referenca 2); do 17% djece
- Prevalencija noćnih strahova: 1-6% djeca, <1% odrasli prema ICSD-3-TR
- Prevalencija konfuznih buđenja: do 17% djece prema ICSD-3-TR
- Obiteljska anamneza pozitivna u do 60% somnambulista — Zadra et al. 2013 (referenca 10)
- Diferencijalna dijagnoza NREM vs. RBD vs. SHE — strukturirano prema Castelnovo et al. 2018 (referenca 6)
- SHE (sleep-related hypermotor epilepsy) — nova nomenklatura prema Tinuper et al. 2016 (referenca 8)
- Planirana buđenja (scheduled awakenings) — podržano u Galbiati et al. 2015 (referenca 5)
- Klonazepam ~80% učinkovitost za NREM parasomnije — prema Proserpio et al. 2018 (referenca 9)
-->
