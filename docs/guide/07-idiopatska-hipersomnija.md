...
!!! crvena-zastavica "Crvene zastavice"
    ...
    - **Pospanost za volanom / drowsy driving** — značajno povećan rizik prometne nesreće; pacijent može zaspati bez upozorenja
    - **Nemogućnost funkcioniranja na poslu ili u školi** — opetovano kašnjenje, zasipanje na radnom mjestu, pad akademskog uspjeha, gubitak posla
    - **Propuštanje važnih životnih događaja** — pacijent ne može ustati na ispit, svadbu, let; propušta preglede jer se ne može probuditi
    - **Socijalna izolacija** — okolina tumači simptome kao lijenost ili nedostatak motivacije; pacijent internalizira stigmu
    - **Depresivna simptomatologija sekundarna na IH** — kronična nemogućnost funkcioniranja dovodi do reaktivne depresije; liječenje samo depresije ne rješava pospanost
...
!!! zamka "Česte zamke"
    ...
    |---|---|
    | „Samo je depresivan/a" — proglasiti pospanost simptomom depresije | Depresija ima **gubitak interesa, anhedoniju, promjenu apetita, suicidalnost**; IH ima izolirani problem s pospanosti i spavanjem. Mogu koegzistirati — liječiti oboje, ali ne ignorirati EDS kao „samo psihičko". |
    | Ne isključiti sindrom nedovoljnog sna prije daljnje obrade | **2 tjedna dnevnika spavanja s produženim vremenom u krevetu** — ako simptomi nestanu s ≥9h sna, to je nedovoljan san, ne IH. Ovo je najčešći imitator i najčešći uzrok pogrešne dijagnoze. |
    | Postaviti dijagnozu „narkolepsije" bez MSLT-a | IH i narkolepsija tip 2 zahtijevaju **MSLT za razlikovanje** — razlika je u broju SOREMP-ova. Dijagnoza bez MSLT-a je nepouzdana i može dovesti do krivog liječenja. |
    | Odmah propisati stimulanse (metilfenidat, modafinil) | **Uputiti specijalistu za formalnu dijagnostiku.** Stimulansi bez dijagnoze maskiraju simptome, otežavaju kasniji MSLT i izlažu pacijenta nepotrebnom riziku. |
    | Reći pacijentu da je „lijen" ili da „samo treba ranije leći" | IH je neurobiološki poremećaj — pacijent spava više od svih oko sebe i budi se gore nego itko. Ovo je medicinski problem, ne problem discipline. Validirati pacijentov doživljaj. |
    | Ne pitati za inerciju spavanja | Inercija spavanja je najspecifičniji simptom IH — **bez ciljane anamneze neće biti prepoznata**. Pitajte: „Koliko vam treba da se potpuno probudite? Jeste li zbunjeni ili dezorijentirani po buđenju?" |
...
1. Dauvilliers Y, Arnulf I, Szakacs Z, et al. Long-term use of lower-sodium oxybate for the treatment of idiopathic hypersomnia: the LAUNCH clinical trial. *Ann Neurol.* 2021;90(S26):S267. (Vidi i: Dauvilliers Y, et al. Effect of lower sodium oxybate on idiopathic hypersomnia: results from a prospective, placebo-controlled, double-blind, randomized clinical trial. *Lancet Neurol.* 2024;23(3):271-281.)

2. American Academy of Sleep Medicine. *International Classification of Sleep Disorders.* 3rd ed., Text Revision (ICSD-3-TR). Darien, IL: AASM; 2023.

3. Trotti LM. Idiopathic hypersomnia. *Sleep Med Clin.* 2017;12(3):331-344.

4. Ali M, Auger RR, Slocumb NL, Morgenthaler TI. Idiopathic hypersomnia: clinical features and response to treatment. *J Clin Sleep Med.* 2009;5(6):562-568.

5. Lammers GJ, Bassetti CLA, Dolenc-Groselj L, et al. Diagnosis of central disorders of hypersomnolence: a reappraisal by European experts. *Sleep Med Rev.* 2020;52:101306.

6. Trotti LM, Staab BA, Rye DB. Test-retest reliability of the multiple sleep latency test in narcolepsy without cataplexy and idiopathic hypersomnia. *J Clin Sleep Med.* 2013;9(8):789-795.
...
<!--
NAPOMENE ZA AUTORA:
- MKB-10 G47.1 pokriva hipersomniju uključujući IH; nema specifičnijeg šifriranja
- ICSD-3-TR (2023) kriteriji za IH: EDS ≥3 mjeseca, MSLT latencija ≤8 min s <2 SOREMP-a ILI 24h ukupno spavanje ≥11h; isključeni drugi uzroci
- Dauvilliers 2021/2024: LAUNCH trial — Xywav (lower-sodium oxybate) za IH, FDA odobrenje kolovoz 2021
- Modafinil: dostupan u Hrvatskoj uz posebno odobrenje (HALMED, veljača 2026)
- Xywav: NIJE dostupan u Hrvatskoj (HALMED, veljača 2026)
- Solriamfetol: NIJE dostupan u Hrvatskoj (HALMED, veljača 2026)
- Pitolisant: odobren u EU za narkolepsiju; off-label za IH; ograničena dostupnost u HR
- Prevalencija IH: Ohayon et al. (2013) procjenjuje <0,01%; centar-bazirane studije 1-3% dijagnoza
- Prosječno vrijeme do dijagnoze (10-15 godina): Trotti 2017, Ali 2009
- MSLT zahtijeva prethodno noćno spavanje ≥7h i ukidanje REM-supresivnih lijekova ≥2 tjedna
- Usporedna tablica IH vs NT2 vs ISS: konsolidacija iz Lammers 2020 i ICSD-3-TR
- Broj riječi: ~2.400
-->
