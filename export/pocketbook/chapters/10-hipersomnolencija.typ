...
*Epworthova ljestvica pospanosti (ESS)* — ESS ≥10 = prekomjerna pospanost; ESS ≥16 = teška (čest nalaz kod narkolepsije). Brz (2–3 min), validiran na hrvatskom.
...
*Dijagnozu narkolepsije MORA postaviti specijalist* na temelju PSG + MSLT ili hipokretina-1 u likvoru.
