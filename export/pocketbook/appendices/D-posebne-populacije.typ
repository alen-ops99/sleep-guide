// ============================================================================
// Dodatak D — Posebne populacije
// ============================================================================

#import "../template.typ": *

#appendix-title(letter: "D", title: "Posebne populacije")

=== Stariji (>65 g.) — sažetak kroz sve poremećaje
...
- *Nesanica:* CBT-I jedina sigurna opcija; zolpidem i BZD kontraindicirani (kategorija C/D)
- *RLS:* Prevalencija do 25–30% u trećem trimestru; provjeriti feritin i folat; gabapentin — ograničeni podaci o sigurnosti
